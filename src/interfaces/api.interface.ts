...
export interface Availability {
  status: string;
  available_to_browse: boolean | null;
  available_to_borrow: boolean | null;
  available_to_waitlist: boolean | null;
  is_printdisabled: boolean | null;
  is_readable: boolean | null;
  is_lendable: boolean | null;
